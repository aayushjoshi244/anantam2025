    ...
    <div id="contact" className="my-20 min-h-96 w-screen px-10">
      <div className="relative rounded-lg bg-black py-24 text-blue-50 sm:overflow-hidden">
        ...
        <div className="flex flex-col items-center text-center z-10 relative">
          <p className="mb-10 font-general text-[15px] uppercase">Join Anantam bkbiet</p>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50" style={{ backgroundColor: "#f2be2265" }}>
          <div className="bg-gradient-to-b from-black to-black p-10 rounded-lg w-[95%] max-w-lg text-white relative shadow-xl min-h-[550px]" style={{ backgroundColor: "#000000" }}>
            <button
            ...
            <h3 className="text-3xl font-bold mb-8 text-center" style={{ color: "#ffbc21" }}>Contact Us</h3>

            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="flex flex-col">
                <label className="mb-2 text-lg font-medium" style={{ color: "#ffbc21" }}>Your Name</label>
                <input
                  type="text"
                  name="name"
              ...
              <div className="flex flex-col">
                <label className="mb-2 text-lg font-medium" style={{ color: "#ffbc21" }}>Your Email</label>
                <input
                  type="email"
                  name="email"
              ...
              <div className="flex flex-col">
                <label className="mb-2 text-lg font-medium" style={{ color: "#ffbc21" }}>Your Message</label>
                <textarea
                  name="message"
